...
{    
	...
	#else
		this->skyboxPositiveXID = TextureLoader::LoadTexture("../Assets/Textures/skyboxPositiveX.png");
		this->skyboxNegativeXID = TextureLoader::LoadTexture("../Assets/Textures/skyboxNegativeX.png");
		this->skyboxPositiveYID = TextureLoader::LoadTexture("../Assets/Textures/skyboxPositiveY.png");
		this->skyboxNegativeYID = TextureLoader::LoadTexture("../Assets/Textures/skyboxNegativeY.png");
		this->skyboxPositiveZID = TextureLoader::LoadTexture("../Assets/Textures/skyboxPositiveZ.png");
		this->skyboxNegativeZID = TextureLoader::LoadTexture("../Assets/Textures/skyboxNegativeZ.png");
	#endif
