...
: mpDescriptor(descriptor), mpEmitter(emitter)
{
    ...
    {
        *it = new Asteroid(mpEmitter->GetAsteroidRandomPosition());
    }
...
void AsteroidSystem::Update(float dt)
{
    ...
    float averageTimeBetweenEmission = 20.0f / mpDescriptor->emissionRate;
